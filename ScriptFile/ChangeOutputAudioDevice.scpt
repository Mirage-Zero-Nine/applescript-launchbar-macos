...
try
	tell application "System Events"
		tell process "Audio MIDI Setup"
			select ((UI elements of outline 1 of scroll area 1 of splitter group 1 of window "Audio Devices") whose description is "MacBook Pro Speakers") -- change your output device name here
			set target to value of attribute "AXFocusedUIElement"
			
			-- simulation of "right click"
